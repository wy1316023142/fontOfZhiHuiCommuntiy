<template>
    <div class="alarmEventBigBox">
        <div class="alarmEventTop">
            <div class="alarmEventTopText1">
                <p class="mt12">发生</p>
                <p class="b7ebfe">{{gaugeTotal1}}</p>
            </div>
            <div class="alarmEventTopCharts" v-show="alarmEventTopChartsShow">
                <p>{{organName1}}</p>
...
.alarmEventBigBox{
    ...
    .alarmEventTop{
        ...
        .alarmEventTopText1{
            width: 114px;
            height: 95px;
            background: url('../../assets/image/helong/1.png') no-repeat;
            p{
                margin-left: 20px;
            }
        }
        .alarmEventTopText2{
            width: 114px;
            height: 95px;
            background: url('../../assets/image/helong/2.png') no-repeat; 
            p{
                margin-left: 48px;
            }
        }
    ...
    .alarmEventBottom{
        ...
        width: 114px;
        height: 95px;
        background: url('../../assets/image/helong/3.png') no-repeat;
        p{
            margin-left: 20px;
        }
        }
        .alarmEventBottomText2{
            width: 114px;
            height: 95px;
            background: url('../../assets/image/helong/4.png') no-repeat;
            p{
                margin-left: 48px;
            }
        }
