...
//获取URL参数
export function  getUrlParame (name,url=null) {
...
//
export function dual(num) {
    if(num>=0&&num<10) return '0000'+num;
    if(num>=10&&num<100) return '000'+num;
    if(num>=100&&num<1000) return '00'+num;
    if(num>=1000&&num<10000) return '0'+num;
}
